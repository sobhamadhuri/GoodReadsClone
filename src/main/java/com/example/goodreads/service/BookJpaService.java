//It uses ORM queries to implement the business logic
...
@Service//Mark a class as service provider
public class BookJpaService implements BookRepository{
    ...
    @Override
    public String addBulkOfBooks(ArrayList<Book> book){
        int count=0;
        for (Book book1 : book){
            bookJpaRepository.save(book1);
            count+=1;
        }
        return String.format("Successsfully added %d books", count);
